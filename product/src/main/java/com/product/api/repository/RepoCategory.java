...
/**
 * Implementación de la clase RepoCategory 
...
public interface RepoCategory extends JpaRepository<Category, Integer> {
	...
	@Query(value = "SELECT * FROM category WHERE category = :category AND acronym = :acronym AND category_id = :category_id", nativeQuery = true)
	Category findByCategory(@Param("category") String category, @Param("acronym") String acronym,@Param("category_id") Integer category_id);
